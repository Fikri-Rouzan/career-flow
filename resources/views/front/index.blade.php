        ...
        <header class="container max-w-[1130px] mx-auto flex items-center justify-between gap-[50px] mt-[70px]">
            <div class="flex flex-col justify-center w-full gap-10">
                <div class="badge flex items-center rounded-full py-2 pl-4 pr-6 gap-[10px] bg-white w-fit">
                    ...
                    <p class="font-semibold text-sm leading-[21px] text-[#0C0039]">Empowering 5 Million Careers Worldwide
                    </p>
                </div>
                <div class="flex flex-col gap-4">
                    <h1 class="font-black text-[60px] leading-[70px] text-white">Find Your<br>Dream Job</h1>
                    <p class="text-lg leading-[34px] text-white">The most trusted platform to build your career and find a
                        job you'll love</p>
                </div>
            ...
            <div class="flex shrink-0 w-[548px]">
                <img src="{{ asset('assets/backgrounds/hero-illustration.png') }}" class="object-contain" alt="banner">
            </div>
        </header>
