        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <div class="item-card flex flex-row gap-y-10 justify-between md:items-center">
                    <div class="flex flex-row items-center gap-x-3">
                        ...
                        <div class="flex flex-col">
                            <h3 class="text-indigo-950 text-xl font-bold">Lorem ipsum dolor sit amet</h3>
                            <p class="text-slate-500 text-sm">Lorem ipsum dolor sit amet</p>
                        </div>
                    </div>
                ...
                <div class="flex flex-col gap-y-3">
                    ...
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro optio velit incidunt possimus
                        consequatur esse excepturi minima perspiciatis iure eveniet iusto dolores inventore voluptatem,
                        quo itaque autem aut numquam nulla?
                    </p>
                </div>
