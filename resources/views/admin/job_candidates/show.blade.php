            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="flex flex-row justify-between">
                    <div class="flex flex-col gap-y-3 basis-3/4">
                        ...
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ratione molestias optio quas
                            distinctio, pariatur aut iusto. Ad quasi nesciunt harum animi consectetur eos ea repellendus
                            iure eveniet alias. Libero, adipisci!
                        </p>
                    </div>
